...
class FeaturedProgramming extends Component {
  ...
  render(props) {
    ...
    return (
      <div className=" mt0 flex flex-column justify-center white pv6 ph4">
        ...
        <div className="flex flex-row-l flex-column justify-center-ns justify-start items-center w-100 mb0  bb bt b--white pv4 ">
          ...
          <div className=" pa4">
            <div className=" pa4 bg-black-20 br2">
        ...
        <h3 className=" tc mt4 mb1 tracked">Like what you see? Check out all my programming projects...</h3>
        <div  className=" mt2-ns h3 center dib ph3 w-100  flex flex-row-ns flex-column justify-center ">
            <Link to={"/programming/"}
              className="mh2  mt2 mt0-ns ba white tracked br2 fw8  h-auto-ns f6-ns w-100 w-auto-ns f7 pv3-ns pv2 ph3 no-underline underline-hover shadow-3 self-center">Explore projects</Link>
        </div>
      </div>
    );
  }
